...
;;Nie jest to kod który do końca sam wymyśliłem .
;;Wspomagałem się Stack Overflow!!!!!!!
...
(define(msm-sign sm)
  (car sm))
(define(msm-message sm)
  (cdr sm))
  
(define (encrypt-and-sign message recipient-public-key sender-private-key)
  (make-signed-message(compress (RSA-encrypt message sender-private-key))
...
(define (authenticate-and-decrypt cyphertext recipient-private-key sender-public-key)
  (if(=(msm-sign cyphertext)
    ( compress (RSA-encrypt
                (RSA-decrypt
                 (msm-message cyphertext) sender-public-key)
                sender-public-key)))
  (RSA-decrypt (msm-message cyphertext) sender-public-key)
  (display "Syngalizacja problemu  ")))
...
(RSA-convert-list '(1 2 3 ) (make-key 816898139 180798509))
(RSA-unconvert-list '(1 1 46673318 )(make-key 816898139 301956869)  )

(solve-ax+by=1 4 1231)
(solve-ax+by=1 23 12312)


(encrypt-and-sign "Testowanie dzialania" (make-key 816898139 180798509)
                  (make-key 816898139 301956869))


(newline)
(authenticate-and-decrypt (encrypt-and-sign "Testowanie dzialania" (make-key 816898139 180798509)
                  (make-key 816898139 301956869))
                   (make-key 816898139 180798509)  (make-key 816898139 301956869) )
(newline)
(encrypt-and-sign "Life is like a box of chocolates"
                  (make-key 513756253 416427023)(make-key 513756253 462557987))
(newline)
(authenticate-and-decrypt (encrypt-and-sign "Life is like a box of chocolates"
                  (make-key 513756253 416427023)(make-key 513756253 462557987))
                          (make-key 513756253 416427023)(make-key 513756253 462557987))
